...
\usepackage{etoolbox}
\BeforeBeginEnvironment{Verbatim}{\vspace{30pt}}
\AfterEndEnvironment{Verbatim}{\vspace{30pt}}
\BeforeBeginEnvironment{lstlisting}{\vspace{6pt}}
\AfterEndEnvironment{lstlisting}{\vspace{1pt}}
